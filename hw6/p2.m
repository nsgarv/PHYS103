...
for (h = 1:length(j))
	...
	kk = [-2*k(1)-k(2) , k(1) , k(2); k(1) , -2*k(1)-k(2) , k(1); k(2) , k(1) , -k(1)-k(2)];
	b = [k(2); -k(2); -k(1)-k(2)];
...
ylabel('Ratio of spring constants k(1)/k(2)');
xlabel('Total Length of the system in steadystate equilibrium');
%hold on;
